...
export const categories: Category[] = [
  ...
  },
  {
    ...
    image: '/images/products/barrier.jpg',
    productCount: 6,
  },
  {
    id: 'cat-3',
    ...
    image: '/images/products/hexagonal-mesh.jpg',
    productCount: 4,
  },
  {
    id: 'cat-4',
...
- Landscaping and architectural features`,
    ...
    images: [
      '/images/products/gabion-box.jpg',
      '/images/products/ai-generated/gabion-box-3x1x1m.jpg',
      '/images/products/gabion-pvc.jpg',
    ],
    moq: 100,
    priceUsd: 45,
...
- Bottom protection of drainage channels`,
    ...
    images: [
      '/images/products/reno-mattress.jpg',
    ],
    moq: 50,
    priceUsd: 55,
    priceRemark: 'FOB Tianjin',
...
- Steep terrain protection`,
    ...
    images: [
      '/images/products/protection-net.jpg',
    ],
    moq: 500,
    priceUsd: 85,
...
- Insulation wrapping`,
    ...
    images: [
      '/images/products/hexagonal-mesh.jpg',
    ],
    moq: 50,
    priceUsd: 35,
...
- Residential property boundaries`,
    ...
    images: [
      '/images/products/chain-link.jpg',
    ],
    moq: 50,
    priceUsd: 25,
    priceRemark: 'FOB Tianjin, per roll',
